  ...
  />
        ...
        <div className="space-y-12">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div className="md:w-1/2">
              ...
              <p className="mt-2 text-gray-300">Upload your resume and let our AI do the matching.</p>
            </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            <div className="md:w-1/2 text-right">
              ...
              <p className="mt-2 text-gray-300">Explore matching gigs curated just for your skills.</p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div className="md:w-1/2">
              ...
              <p className="mt-2 text-gray-300">Apply directly and track your applications seamlessly.</p>
            </div>
            <div className="md:w-1/2 hidden md:flex justify-end"></div>
          </div>
        </div>
      ...
      <section className="bg-white text-black py-20 px-6">
        ...
        <p className="text-lg max-w-4xl">
          Our goal is to simplify and personalize the job hunt experience using AI-driven gig matching.
          We empower individuals by connecting them to opportunities that fit their unique skillsets.
        </p>
      </section>
