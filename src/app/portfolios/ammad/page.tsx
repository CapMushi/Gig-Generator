// File: src/app/portfolios/ammad/page.tsx
...
export default function AmmadPortfolio() {
      ...
      <section className="flex flex-col md:flex-row items-center justify-center flex-1 px-6 py-12 max-w-7xl mx-auto gap-12">
        ...
        <div className="flex-1">
          ...
          <h1 className="text-4xl md:text-5xl font-bold">
            I'm <span className="text-orange-400">Ammad</span>
          </h1>
          ...
          <p className="mt-6 text-gray-200 max-w-xl">
            From backend APIs in Node.js to dynamic frontends with React, I love building scalable
            web applications. Passionate about performance, clean code, and delivering a great
