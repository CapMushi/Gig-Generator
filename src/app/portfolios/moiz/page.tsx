// File: src/app/portfolios/muiz/page.tsx
...
export default function MuizPortfolio() {
      ...
      <section className="flex flex-col md:flex-row items-center justify-center flex-1 px-6 py-12 max-w-7xl mx-auto gap-12">
        ...
        <div className="flex-1">
          ...
          <h1 className="text-4xl md:text-5xl font-bold">
            I'm <span className="text-orange-400">Muiz</span>
          </h1>
          ...
          <p className="mt-6 text-gray-200 max-w-xl">
            I specialize in creating intuitive and elegant user experiences. With a passion
            for visual storytelling, I blend design thinking and frontend know-how to craft
            interfaces that users love and businesses value.
          </p>
