// File: src/app/portfolios/mustafa/page.tsx
      ...
      <section className="flex flex-col md:flex-row items-center justify-center flex-1 px-6 py-12 max-w-7xl mx-auto gap-12">
        ...
        <div className="flex-1">
          ...
          <h1 className="text-4xl md:text-5xl font-bold">
            I'm <span className="text-orange-400">Mustafa</span>
          </h1>
          ...
          <p className="mt-6 text-gray-200 max-w-xl">
            I specialize in automation, CI/CD pipelines, and cloud infrastructure using AWS and Docker.
            My goal is to streamline development and deployment processes, ensuring reliability and scalability.
          </p>
