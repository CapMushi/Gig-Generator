// File: src/app/portfolios/taha/page.tsx
...
export default function TahaPortfolio() {
      ...
      <section className="flex flex-col md:flex-row items-center justify-center flex-1 px-6 py-12 max-w-7xl mx-auto gap-12">
        ...
        <div className="flex-1">
          ...
          <h1 className="text-4xl md:text-5xl font-bold">
            I'm <span className="text-orange-400">Taha</span>
          </h1>
          ...
          <p className="mt-6 text-gray-200 max-w-xl">
            I love diving deep into C++ and cybersecurity — from managing memory and building
            performant system-level code to analyzing vulnerabilities and strengthening
            digital defenses. I thrive on solving low-level problems with high impact.
          </p>
